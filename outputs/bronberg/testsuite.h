/** @file
 *	@brief MAVLink comm protocol testsuite generated from bronberg.xml
 *	@see http://qgroundcontrol.org/mavlink/
 */
#ifndef BRONBERG_TESTSUITE_H
#define BRONBERG_TESTSUITE_H
...
static void mavlink_test_bronberg(uint8_t, uint8_t, mavlink_message_t *last_msg);

static void mavlink_test_all(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{

	mavlink_test_bronberg(system_id, component_id, last_msg);
}
#endif
...
static void mavlink_test_simulink(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
	mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_SIMULINK >= 256) {
        	return;
        }
#endif
	mavlink_message_t msg;
        ...
        uint16_t i;
	mavlink_simulink_t packet_in = {
		93372036854775807ULL,93372036854776311ULL,129.0,157.0,185.0,213.0,241.0,269.0,297.0,325.0,353.0,381.0,409.0,437.0,465.0,493.0,521.0,549.0,577.0,605.0,633.0,661.0,689.0,717.0,745.0,773.0,801.0,829.0
    };
	mavlink_simulink_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.time_usec = packet_in.time_usec;
        packet1.counter = packet_in.counter;
        packet1.stick_input0 = packet_in.stick_input0;
        packet1.stick_input1 = packet_in.stick_input1;
        packet1.stick_input2 = packet_in.stick_input2;
        packet1.stick_input3 = packet_in.stick_input3;
        packet1.stick_input4 = packet_in.stick_input4;
        packet1.pos_x = packet_in.pos_x;
        packet1.pos_y = packet_in.pos_y;
        packet1.pos_z = packet_in.pos_z;
        packet1.v_x = packet_in.v_x;
        packet1.v_y = packet_in.v_y;
        packet1.v_z = packet_in.v_z;
        ...
        packet1.signal_1 = packet_in.signal_1;
        packet1.signal_2 = packet_in.signal_2;
        packet1.signal_3 = packet_in.signal_3;
        packet1.probe_1 = packet_in.probe_1;
        packet1.probe_2 = packet_in.probe_2;
        packet1.probe_3 = packet_in.probe_3;
        packet1.probe_4 = packet_in.probe_4;
        packet1.probe_5 = packet_in.probe_5;
        packet1.probe_6 = packet_in.probe_6;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_SIMULINK_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_SIMULINK_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_simulink_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_simulink_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_simulink_pack(system_id, component_id, &msg , packet1.time_usec , packet1.counter , packet1.stick_input0 , packet1.stick_input1 , packet1.stick_input2 , packet1.stick_input3 , packet1.stick_input4 , packet1.pos_x , packet1.pos_y , packet1.pos_z , packet1.v_x , packet1.v_y , packet1.v_z , packet1.roll , packet1.pitch , packet1.yaw , packet1.rollspeed , packet1.pitchspeed , packet1.yawspeed , packet1.signal_1 , packet1.signal_2 , packet1.signal_3 , packet1.probe_1 , packet1.probe_2 , packet1.probe_3 , packet1.probe_4 , packet1.probe_5 , packet1.probe_6 );
	mavlink_msg_simulink_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_simulink_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.time_usec , packet1.counter , packet1.stick_input0 , packet1.stick_input1 , packet1.stick_input2 , packet1.stick_input3 , packet1.stick_input4 , packet1.pos_x , packet1.pos_y , packet1.pos_z , packet1.v_x , packet1.v_y , packet1.v_z , packet1.roll , packet1.pitch , packet1.yaw , packet1.rollspeed , packet1.pitchspeed , packet1.yawspeed , packet1.signal_1 , packet1.signal_2 , packet1.signal_3 , packet1.probe_1 , packet1.probe_2 , packet1.probe_3 , packet1.probe_4 , packet1.probe_5 , packet1.probe_6 );
	mavlink_msg_simulink_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_simulink_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_bronberg(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_test_simulink(system_id, component_id, last_msg);
